                            ...
                            <div class="card-1 br-4">
                                ...
                                <ul class="list-inline badge-collapsed-img badge-tooltip mt-5 mb-0 text-right mr-3">
                                    <li class="list-inline-item chat-online-usr">
                                        <img data-original-title="Alma Clarke" alt="admin-profile" src="{{ asset('Equation3/ltr/assets/img/90x90.jpg') }}" class="ml-0 bs-tooltip">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img data-original-title="Alan Green" alt="admin-profile" src="{{ asset('Equation3/ltr/assets/img/90x90.jpg') }}" class="bs-tooltip">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img data-original-title="Daisy Anderson" alt="admin-profile" src="{{ asset('Equation3/ltr/assets/img/90x90.jpg') }}" class="bs-tooltip">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img data-original-title="Judy Holmes" alt="admin-profile" src="{{ asset('Equation3/ltr/assets/img/90x90.jpg') }}" class="bs-tooltip">
                                    </li>
                                </ul>                                
                            </div>
                        </div>
